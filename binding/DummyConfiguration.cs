...
namespace DummyBinding
{
    ...
    {
        private IDummyBindingService TestService { get; }

        public DummyConfiguration (IDummyBindingService testService) {
        ...
        private DummyMessage BuildItemFromAttribute(DummyAttribute arg)
        {
            ...
            return new DummyMessage { Id = "foo", Name = TestService.GetMessage() };
        }
    }
}
